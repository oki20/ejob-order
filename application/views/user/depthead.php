        ...
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="modalRequestLabel">Form Data Dept Head</h5>
                ...
                <div class="modal-body">
                    ...
                    <div class="form-group row">
                        <label class="col-md-2 col-form-label">Nama Dept. Head</label>
                        <div class="col-md-10">
                            <input type="text" name="name" id="name" class="form-control" placeholder="Masukkan Nama Dept. Head" required>
                        </div>
                    </div>
                    <div class="form-group row">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-md-10">
                            <input type="text" name="departemen" id="departemen" class="form-control" placeholder="Masukkan Departemen" required>
                        </div>
                    </div>
                    <div class="form-group row">
...
<script type="text/javascript">
    $(document).ready(function() {
        ...
        function tampildata() {
            $.ajax({
                type: 'post',
                url: '<?php echo site_url('user/tampildatadh') ?>',
                async: false,
                dataType: 'json',
        ...
        $('#btn_save').on('click', function() {
            ...
            // Validasi untuk memastikan departemen tidak kosong
            else if (departemen === '') {
                Swal.fire({
                    type: 'warning',
                    title: 'Oops...',
                    text: 'Departemen harus diisi dengan benar!'
                });
                return false;
            }
            ...
            // Validasi untuk email harus berakhir dengan '@gt-tires.com'
                ...
                $.ajax({
                    type: "POST",
                    url: "<?php echo site_url() ?>/user/simpanDh",
                    data: formData,
                    processData: false,
                    contentType: false,
