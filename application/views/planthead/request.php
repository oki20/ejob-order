            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-md-10">
                            <textarea class="form-control" placeholder="Masukkan Saran JO Reject" id="saran_plant" name="saran_plant" style="height: 100px"></textarea>
                        </div>
            ...
            success: function(data) {
                ...
                for (i = 0; i < data.length; i++) {
                    ...
                    html += '<tr>' +
                        ...
                        '<button class="btn btn-info btn-sm" onclick="approveData(' + data[i].id + ')">Approve</button>' + ' ' +
