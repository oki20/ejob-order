            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" name="no_file_edit" id="no_file_edit" class="form-control" placeholder="Nomor Transaksi" disabled>
                    </div>
                    <div class="mb-3">
...
<script type="text/javascript">
    ...
    $(document).ready(function() {
                ...
                success: function(data) {
                    ...
                    for (i = 0; i < data.length; i++) {
                        ...
                        html += '<tr>' +
                            ...
                            '<a href="javascript:void(0);" class="btn btn-info btn-sm item_edit" data-informasi_id="' + data[i].informasi_id +
                            '" data-no_info="' + data[i].no_info + '" data-pekerjaan="' + data[i].pekerjaan + '"><i class="fas fa-percentage"></i> Buat Laporan</a>' + ' ' +
                            '</td>' +
                            '</tr>';
                    }
                    $('#show_data').html(html);
        ...
        $('#show_data').on('click', '.item_edit', function() {
            var informasi_id = $(this).data('informasi_id');
            var no_info = $(this).data('no_info');
            var pekerjaan = $(this).data('pekerjaan');

            $('#Modal_Edit').modal('show');
            $('[name="id_edit"]').val(informasi_id);
            $('[name="no_file_edit"]').val(no_info);
        ...
        $('#btn_save').click(function() {
            ...
            if (!tgl_pengerjaan) {
                ...
                $.ajax({
                    type: "POST",
                    url: "<?php echo site_url('leader/createinform') ?>",
                    data: formData,
                    processData: false,
                    contentType: false,
